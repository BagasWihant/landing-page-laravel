<div>
    <div class="col-lg-2 col-md-3 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
        ...
        <button class="btn btn-icon btn-3 bg-gradient-info" type="button" data-bs-toggle="modal"
            ...
            <span class="btn-inner--text"> Layanan</span>
        </button>
                        ...
                        <div class="card card-plain">
                            <div class="card-header pb-0 text-left">
                                @if ($kondisiModal == 'tambah')
                                    <h5 class="font-weight-bolder text-center text-info text-gradient">Tambah Layanan
                                    </h5>
                            </div>
                            <div class="card-body">
                                ...
                                @else
                                    <h5 class="font-weight-bolder text-center text-warning text-gradient">Update Layanan
                                    </h5>
                            </div>
                            <div class="card-body">
                    ...
                    @foreach ($data as $d)
                        <tr>
                            ...
                            <td class="white-space-normal">
                                <div class="d-flex px-2">
                                    <div class="my-auto">
                                        <span class="mb-0 text-md">{{ $d->deskripsi }}</span>
                                    </div>
                                </div>
                            </td>
                            <td>
